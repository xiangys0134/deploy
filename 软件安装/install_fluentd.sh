...
function install_rpm() {
    ...
    if [ $? -ne 0 ]; then
        echo "\033[31mtd-agent-3.2.0-0.el7.x86_64.rpm download failure\033[0m"
        exit 6
    else
        echo "\033[32mtd-agent-3.2.0-0.el7.x86_64.rpm download success\033[0m"
    fi

    if [ `check_rpm redhat-lsb-core` -eq 0 ]; then
        echo "\033[32mredhat-lsb-core ready to install...\033[0m"
    ...
    echo "\033[32mstart up td-agent.service...\033[0m"
