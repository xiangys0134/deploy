...
JAVA_OPTS="${JAVA_OPTS} -server -Xms2G -Xmx2G -Xss256K \
      ...
      -Dapp.home=${APP_HOME} -Djava.awt.headless=true -Djasypt.encryptor.password=xuncetech"
...
start()
{
    ...
    "$JAVACMD" $JAVA_OPTS  -jar ${APP_HOME}/$JAR $APP_ARGS
    echo $! > ${RUNNING_PID}
    popd > /dev/null
