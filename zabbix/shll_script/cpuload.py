...
def msg_send(user,password,receivers,title,content):
    ...
    #mail_user = "ops@agc.com" # 用户名
    #mail_pass = "123456" # 密码

    #sender = 'ops@agc.com' # 发件人邮箱(最好写全, 不然会失败)
...
while True:
    ...
    if 172420 >= t >= 172318:
        ...
        msg_send('ops@agc.com', '123456', ['aa@agc.com','bb@agc.com','cc@agc.com','dd@agc.com','ee@agc.com','ff@agc.com'],'CPU:' + myaddr + myname + '当前12小时内最高负载','时间：' + cpuload_key + 'CPU负载：' + cpuload_max)
        dc = {}
    time.sleep(61)
    flag += 1
